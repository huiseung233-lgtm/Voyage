...
object WorldData {
    ...
    val ports = listOf(
        ...
        Port(id = 1, name = "Westia North", posX = -7500.0, posY = 1000.0, hasShipyard = true, hasTavern = true, hasMarket = true),
        Port(id = 2, name = "Westia South", posX = -7500.0, posY = -1000.0, hasMarket = true),
        
        // East Continent Ports
        Port(id = 3, name = "Eastia Main", posX = 7000.0, posY = 0.0, hasShipyard = true, hasTavern = true, hasMarket = true),
        Port(id = 4, name = "Eastia North", posX = 7800.0, posY = 1500.0, hasMarket = true),

        // Mid-land Ports
        Port(id = 5, name = "North Junction", posX = 0.0, posY = 3200.0, hasTavern = true, hasMarket = true),
        Port(id = 6, name = "South Junction", posX = 0.0, posY = -3200.0, hasMarket = true),
        
        // Scattered (Fill up to ~25)
        Port(id = 7, name = "Mist Isle", posX = -4000.0, posY = 5700.0, hasMarket = true),
        Port(id = 8, name = "Coral Port", posX = 4000.0, posY = -5700.0, hasMarket = true),
        
        // East Continent Additional
        Port(id = 9, name = "Eastia South", posX = 7800.0, posY = -1500.0, hasMarket = true),
        Port(id = 10, name = "Iron Harbor", posX = 8500.0, posY = 500.0, hasShipyard = true, hasMarket = true),
        
        // West Continent Additional
        Port(id = 11, name = "Westia Harbor", posX = -8500.0, posY = 0.0, hasShipyard = true, hasTavern = true, hasMarket = true),
        Port(id = 12, name = "Cactus Port", posX = -8800.0, posY = 800.0, hasMarket = true),
        
        // Mid-size Land Ports
        Port(id = 13, name = "Center Right Dock", posX = 2000.0, posY = 600.0, hasMarket = true),
        Port(id = 14, name = "Center Left Dock", posX = -2000.0, posY = -1400.0, hasMarket = true),
        
        // Scattered Small Island Ports
        Port(id = 15, name = "Frost Outpost", posX = -1000.0, posY = -8300.0, hasTavern = true, hasMarket = true),
        Port(id = 16, name = "Sunken Reef", posX = 1000.0, posY = 8300.0, hasMarket = true),
        Port(id = 17, name = "Peak Port", posX = 6000.0, posY = 5700.0, hasMarket = true),
        Port(id = 18, name = "Low Port", posX = -6000.0, posY = -6300.0, hasMarket = true),
        Port(id = 19, name = "Northwest Point", posX = -8700.0, posY = 8700.0, hasMarket = true),
        Port(id = 20, name = "Southeast Point", posX = 8700.0, posY = -8700.0, hasMarket = true),
        
        // More scattered
        Port(id = 21, name = "Whale Bay", posX = 0.0, posY = 7000.0, hasMarket = true),
        Port(id = 22, name = "Turtle Beach", posX = 0.0, posY = -7000.0, hasMarket = true),
        Port(id = 23, name = "Shark Fin", posX = 4000.0, posY = 0.0, hasMarket = true),
        Port(id = 24, name = "Dolphin Cove", posX = -4000.0, posY = 0.0, hasMarket = true),

        Port(id = 25, name = "Beginner's Bay", posX = 0.0, posY = 0.0, hasShipyard = true, hasTavern = true, hasMarket = true) // Center start
    )
